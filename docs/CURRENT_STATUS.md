...
- Standalone block and erase history: **FOCUSED PASS**; runtime-safe fallback and live node-tree round trips are covered. Other standalone custom command paths remain open.
