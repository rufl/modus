...
- Standalone custom undo/redo commands: **FOCUSED PASS** for block, erase, paint, transform, selection, paste, duplicate, `EditorState` block placement, and runtime-safe level-save boundaries; full editor UI and manual authoring workflow remain open.
