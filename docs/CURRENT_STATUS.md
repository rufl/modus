...
| Network manager | 15/15; trusted Steam-authenticated peers remain subject to whitelist, rate limits, movement validation, and semantic status/chat/kill/ticket payload validation |
