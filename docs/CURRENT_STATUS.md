...
- Standalone block, erase, and paint history: **FOCUSED PASS**; runtime-safe fallback and live node-tree/material round trips are covered. Other standalone custom command paths remain open.
