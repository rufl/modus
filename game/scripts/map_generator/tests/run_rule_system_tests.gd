...
## Test runner for Rule System tests
## Usage: godot --headless --script game/scripts/map_generator/tests/run_rule_system_tests.gd

extends SceneTree

var _gut = null
var _test_files := ["res://game/scripts/map_generator/tests/test_rule_system.gd"]


func _init() -> void:
	print("\n" + "=".repeat(70))
	print("  RULE SYSTEM TEST SUITE - Task 18 Validation")
	print("  Testing: RuleBase, RuleModuleLoader, RuleExecutionPipeline")
	print("=".repeat(70) + "\n")
...
func _on_tests_finished() -> void:
	...
	if exit_code == 0:
		print("✓ All tests passed! Rule system validated.")
	else:
