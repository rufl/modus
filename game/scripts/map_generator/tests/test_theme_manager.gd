...
func test_incomplete_theme_is_repaired_on_selection() -> void:
	...
	incomplete.theme_type = GenerationConfig.ThemeType.HELL
	theme_manager._themes[GenerationConfig.ThemeType.HELL] = incomplete

	theme_manager.set_theme(GenerationConfig.ThemeType.HELL)

	assert_not_null(incomplete.wall_material)
