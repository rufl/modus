...
## Test runner for Occlusion Culling tests
## Usage: godot --headless --script game/scripts/map_generator/tests/run_occlusion_tests.gd
...
func _init() -> void:
	print("\n" + "=".repeat(70))
	print("  OCCLUSION CULLING TEST SUITE")
	print("=".repeat(70) + "\n")
	...
	# Add test file
	_gut.add_script("res://game/scripts/map_generator/tests/test_occlusion_culling.gd")
...
func _on_tests_finished() -> void:
	...
	if exit_code == 0:
		print("✓ All occlusion culling tests passed!")
	else:
