...
const WeaponManagerClass := preload("res://game/entities/player/components/weapon_manager.gd")
const WeaponDataClass := preload("res://game/weapons/weapon_data.gd")
const WeaponInventoryClass := preload("res://game/entities/player/components/weapon_inventory.gd")
...
func test_machinegun_weapon_exists() -> void:
	...
	assert_eq(machinegun.weapon_name, "Machinegun", "Machinegun should have correct name")
...
func test_rocket_launcher_weapon_exists() -> void:
	...
	assert_eq(
		rocket_launcher.weapon_name, "Rocket Launcher", "Rocket Launcher should have correct name"
	)
...
func test_pistol_is_hitscan() -> void:
	...
	assert_null(pistol.projectile_scene, "Pistol should be hitscan (no projectile scene)")
...
func test_shotgun_is_hitscan() -> void:
	...
	# Verify hitscan
	assert_null(shotgun.projectile_scene, "Shotgun should be hitscan (no projectile scene)")
...
func test_machinegun_is_hitscan() -> void:
	...
	# Verify hitscan
	assert_null(machinegun.projectile_scene, "Machinegun should be hitscan (no projectile scene)")
...
func test_railgun_is_hitscan() -> void:
	...
	# Verify hitscan
	assert_null(railgun.projectile_scene, "Railgun should be hitscan (no projectile scene)")
...
func test_hitscan_weapons_have_zero_projectile_speed() -> void:
	...
	assert_eq(pistol.projectile_speed, 0.0, "Hitscan weapons should have zero projectile speed")
	assert_eq(shotgun.projectile_speed, 0.0, "Hitscan weapons should have zero projectile speed")
...
func test_rocket_launcher_is_projectile() -> void:
	...
	assert_not_null(rocket_launcher.projectile_scene, "Rocket Launcher should be projectile weapon")
...
func test_grenade_launcher_is_projectile() -> void:
	...
	# Verify projectile weapon
	assert_not_null(
		grenade_launcher.projectile_scene, "Grenade Launcher should be projectile weapon"
	)
...
func test_shotgun_total_damage() -> void:
	...
	# Verify total damage
	assert_eq(total_damage, 40, "Shotgun should deal 40 total damage (all pellets)")
...
func test_ammo_refill() -> void:
	...
	assert_eq(ammo[0], pistol.magazine_size, "Refill should restore magazine to full")
...
func test_weapon_switch_updates_ammo_display() -> void:
	...
	# Verify ammo changed
	assert_ne(pistol_ammo[0], shotgun_ammo[0], "Weapon switch should update ammo display")
