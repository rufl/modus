...
class GroundedAdvancedMovement extends AdvancedMovement:
...
func test_bunny_hop_enabled_by_default() -> void:
	assert_true(
		advanced_movement.enable_bunny_hop,
		"Bunny hop should be enabled by default"
	)
...
func test_bunny_hop_increases_speed() -> void:
	...
	# Execute bunny hop
	var result_velocity: Vector3 = advanced_movement.try_bunny_hop(
		player.velocity,
		5.5
	)
	...
	assert_gt(
		final_speed,
		initial_speed,
		"Bunny hop should increase horizontal speed"
	)
...
func test_bunny_hop_respects_speed_cap() -> void:
	...
	assert_lte(
		final_speed,
		advanced_movement.bhop_speed_cap + 1.0,
		"Bunny hop should respect speed cap"
	)
...
func test_bunny_hop_bad_timing_resets_chain() -> void:
	...
	# Verify chain reset
	assert_eq(
		advanced_movement.consecutive_jumps,
		0,
		"Bad timing should reset consecutive jump chain"
	)
...
func test_bunny_hop_good_timing_increments_chain() -> void:
	...
	assert_eq(
		advanced_movement.consecutive_jumps,
		3,
		"Good timing should increment consecutive jumps"
	)
...
func test_air_strafe_allows_direction_change() -> void:
	...
	assert_gt(
		result.x,
		player.velocity.x,
		"Air strafe should allow direction change"
	)
...
func test_air_strafe_no_input_maintains_velocity() -> void:
	...
	assert_almost_eq(
		...
		initial_velocity.x,
		0.5,
		"No input should maintain horizontal velocity"
	)
...
func test_rocket_jump_direction_away_from_explosion() -> void:
	...
	assert_gt(
		boost.y,
		0.0,
		"Rocket jump should propel player away from explosion"
	)
...
func test_rocket_jump_sets_state() -> void:
	...
	# Verify state set
	assert_true(
		rocket_jump_system.is_rocket_jumping,
		"Rocket jump should set is_rocket_jumping state"
	)
...
func test_slide_respects_cooldown() -> void:
	...
	var result: bool = advanced_movement.try_start_slide(
		player.velocity,
		Vector3(1, 0, 0)
	)
...
func test_slide_applies_friction() -> void:
	...
	for i: int in range(10):
		player.velocity = advanced_movement.apply_slide_movement(
			player.velocity,
			0.1
		)
...
func test_dodge_applies_movement() -> void:
	...
	assert_gt(
		result.x,
		0.0,
		"Dodge should apply movement in dodge direction"
	)
...
func test_dodge_reduced_speed_in_air() -> void:
	...
	var expected_speed: float = (
		dodge_system.dodge_speed * dodge_system.air_dodge_speed_multiplier
	)
	...
	assert_almost_eq(
		...
		expected_speed,
		0.1,
		"Air dodge should have reduced speed"
	)
...
func test_peak_speed_tracking() -> void:
	...
	assert_almost_eq(
		...
		10.0,
		0.1,
		"Peak speed should track maximum speed reached"
	)
