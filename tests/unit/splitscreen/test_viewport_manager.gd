...
func test_initial_state_no_viewports() -> void:
	assert_eq(viewport_manager.get_viewport_count(), 0,
		"Should have no viewports initially")
	assert_eq(viewport_manager.get_all_viewports().size(), 0,
...
func test_create_viewport_success() -> void:
	...
	assert_eq(viewport_manager.get_viewport_count(), 1,
		"Should have 1 viewport")
	assert_true(viewport_manager.has_viewport(0),
		"Should have viewport for player 0")
...
func test_create_multiple_viewports() -> void:
	...
	assert_eq(viewport_manager.get_viewport_count(), 4,
		"Should have 4 viewports")
...
func test_create_duplicate_viewport_returns_existing() -> void:
	...
	assert_eq(viewport1, viewport2,
		"Should return the same viewport instance")
	assert_eq(viewport_manager.get_viewport_count(), 1,
		"Should still have only 1 viewport")
...
func test_get_viewport() -> void:
	...
	assert_eq(created_viewport, retrieved_viewport,
		"Should return the same viewport")
...
func test_destroy_viewport() -> void:
	...
	assert_eq(viewport_manager.get_viewport_count(), 0,
		"Should have no viewports after destruction")
	assert_false(viewport_manager.has_viewport(0),
		"Should not have viewport for player 0")
...
func test_2x2_grid_layout_for_4_players() -> void:
	...
	assert_eq(viewport_manager.get_layout_type(), ViewportManager.LayoutType.GRID_2X2,
	...
	for rect: Rect2 in rects:
		assert_almost_eq(rect.size.x, 0.5, 0.01,
			"Viewport width should be ~50%")
		assert_almost_eq(rect.size.y, 0.5, 0.01,
			"Viewport height should be ~50%")
...
func test_2x3_grid_layout_for_5_players() -> void:
	...
	assert_eq(viewport_manager.get_layout_type(), ViewportManager.LayoutType.GRID_2X3,
...
func test_equal_viewport_area_for_4_players() -> void:
	...
	for rect: Rect2 in rects:
		...
		assert_almost_eq(area, expected_area, 0.01,
			"Each viewport should have ~25% of total area")
...
func test_equal_viewport_area_for_6_players() -> void:
	...
	for rect: Rect2 in rects:
		var area: float = rect.size.x * rect.size.y
		assert_almost_eq(area, expected_area, 0.01,
			"Each viewport should have ~16.67% of total area")
...
func test_set_rendering_quality_high() -> void:
	...
	assert_eq(viewport_manager.msaa_mode, Viewport.MSAA_4X,
		"High quality should use MSAA 4X")
	assert_eq(viewport_manager.shadow_quality, "high",
		"High quality should use high shadows")
...
func test_set_rendering_quality_medium() -> void:
	...
	assert_eq(viewport_manager.msaa_mode, Viewport.MSAA_2X,
		"Medium quality should use MSAA 2X")
	assert_eq(viewport_manager.shadow_quality, "medium",
		"Medium quality should use medium shadows")
...
func test_set_rendering_quality_low() -> void:
	...
	assert_eq(viewport_manager.msaa_mode, Viewport.MSAA_DISABLED,
		"Low quality should disable MSAA")
	assert_eq(viewport_manager.shadow_quality, "low",
		"Low quality should use low shadows")
...
func test_has_viewport() -> void:
	assert_false(viewport_manager.has_viewport(0),
		"Should not have viewport initially")
	
	viewport_manager.create_viewport(0, null)
	
	assert_true(viewport_manager.has_viewport(0),
		"Should have viewport after creation")
...
func test_cleanup_all_viewports() -> void:
	...
	assert_eq(viewport_manager.get_viewport_count(), 0,
		"Should have no viewports after cleanup")
...
func test_viewport_created_signal() -> void:
	...
	assert_signal_emitted(viewport_manager, "viewport_created",
		"Should emit viewport_created signal")
...
func test_viewport_destroyed_signal() -> void:
	...
	assert_signal_emitted(viewport_manager, "viewport_destroyed",
		"Should emit viewport_destroyed signal")
...
func test_layout_changed_signal() -> void:
	...
	assert_signal_emitted(viewport_manager, "layout_changed",
		"Should emit layout_changed signal")
...
func test_load_configuration() -> void:
	...
	assert_eq(viewport_manager.msaa_mode, Viewport.MSAA_4X,
		"Should set MSAA to 4X")
	assert_false(viewport_manager.fxaa_enabled,
		"Should disable FXAA")
	assert_eq(viewport_manager.shadow_quality, "high",
		"Should set shadow quality to high")
	assert_almost_eq(viewport_manager.aspect_ratio_variance_threshold, 0.1, 0.01,
...
func test_load_configuration_with_defaults() -> void:
	...
	assert_eq(viewport_manager.msaa_mode, Viewport.MSAA_2X,
		"Should use default MSAA 2X")
	assert_true(viewport_manager.fxaa_enabled,
		"Should enable FXAA by default")
...
func test_viewport_rects_cover_entire_screen() -> void:
	...
	assert_almost_eq(total_area, 1.0, 0.01,
		"Total viewport area should cover entire screen (100%)")
	...
	for i in range(rects.size()):
		for j in range(i + 1, rects.size()):
			...
			assert_false(overlap,
				"Viewports %d and %d should not overlap" % [i, j])
