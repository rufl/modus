...
func test_initial_state_no_assignments() -> void:
	...
	assert_eq(gamepad_controller.get_assigned_device(0), -1,
		"Player 0 should have no device assigned")
...
func test_assign_gamepad_success() -> void:
	...
	assert_eq(gamepad_controller.get_player_for_device(0), 0,
		"Device 0 should be assigned to player 0")
...
func test_assign_nonexistent_device_fails() -> void:
	...
	assert_eq(gamepad_controller.get_assigned_device(0), -1,
		"Player 0 should have no device")
...
func test_assign_duplicate_device_fails() -> void:
	...
	assert_eq(gamepad_controller.get_assigned_device(1), -1,
		"Player 1 should have no device")
...
func test_reassign_device_to_same_player_succeeds() -> void:
	...
	assert_eq(gamepad_controller.get_assigned_device(0), 0,
		"Player 0 should still have device 0")
...
func test_assign_new_device_unassigns_old() -> void:
	...
	assert_eq(gamepad_controller.get_assigned_device(0), 1,
		"Player 0 should have device 1")
	assert_eq(gamepad_controller.get_player_for_device(0), -1,
		"Device 0 should be unassigned")
	assert_false(gamepad_controller.is_device_assigned(0),
		"Device 0 should not be assigned")
...
func test_get_player_for_device() -> void:
	...
	assert_eq(gamepad_controller.get_player_for_device(0), 5,
		"Device 0 should be assigned to player 5")


## Test: Get player for unassigned device returns -1
func test_get_player_for_unassigned_device() -> void:
	assert_eq(gamepad_controller.get_player_for_device(99), -1,
		"Unassigned device should return -1")
...
func test_is_device_assigned() -> void:
	...
	assert_false(gamepad_controller.is_device_assigned(0),
		"Device should not be assigned initially")
	
	gamepad_controller.assign_gamepad(0, 0)
	
	assert_true(gamepad_controller.is_device_assigned(0),
		"Device should be assigned after assignment")
...
func test_get_connected_device_count() -> void:
	...
	assert_eq(gamepad_controller.get_connected_device_count(), 2,
...
func test_get_connected_devices_returns_copy() -> void:
	...
	assert_eq(gamepad_controller.get_connected_device_count(), 1,
...
func test_clear_assignments() -> void:
	...
	assert_eq(gamepad_controller.get_assigned_players().size(), 0,
		"Should have no assigned players")
	assert_eq(gamepad_controller.get_assigned_device(0), -1,
		"Player 0 should have no device")
	assert_eq(gamepad_controller.get_assigned_device(1), -1,
		"Player 1 should have no device")
...
func test_load_configuration() -> void:
	...
	assert_false(gamepad_controller.vibration_enabled,
		"Vibration should be disabled")
	assert_almost_eq(gamepad_controller.analog_deadzone, 0.2, 0.01,
		"Analog deadzone should be 0.2")
	assert_almost_eq(gamepad_controller.trigger_threshold, 0.15, 0.01,
		"Trigger threshold should be 0.15")
...
func test_load_configuration_with_defaults() -> void:
	...
	assert_true(gamepad_controller.vibration_enabled,
		"Vibration should be enabled by default")
	assert_almost_eq(gamepad_controller.analog_deadzone, 0.15, 0.01,
		"Analog deadzone should be default 0.15")
...
func test_gamepad_assigned_signal() -> void:
	...
	assert_signal_emitted(gamepad_controller, "gamepad_assigned",
		"Should emit gamepad_assigned signal")
	assert_signal_emit_count(gamepad_controller, "gamepad_assigned", 1,
		"Should emit signal once")
...
func test_gamepad_unassigned_signal() -> void:
	...
	assert_signal_emitted(gamepad_controller, "gamepad_unassigned",
		"Should emit gamepad_unassigned signal")
...
func test_assignment_complete_signal() -> void:
	...
	assert_signal_emitted(gamepad_controller, "assignment_complete",
		"Should emit assignment_complete signal")
