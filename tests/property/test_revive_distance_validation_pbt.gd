...
func _test_revive_beyond_threshold(test_data: Dictionary) -> bool:
	...
	var distance_beyond: float = rng.randf_range(REVIVE_DISTANCE_THRESHOLD + 0.5, REVIVE_DISTANCE_THRESHOLD + 50.0)
...
func _test_revive_3d_space(test_data: Dictionary) -> bool:
	...
	var player_pos := Vector3(
		...
		rng.randf_range(-50.0, 50.0),  # Significant Y component
		rng.randf_range(-50.0, 50.0)
	)
