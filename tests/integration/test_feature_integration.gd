...
func test_multiple_features_can_subscribe_to_same_event():
	...
	game_manager.subscribe("player_action", func(_data):
		combat_called.value = true
	)
...
func test_features_can_communicate_via_event_bus():
	...
	game_manager.subscribe("test_feature_message", func(data):
		message_received.value = data.get("message")
	)
...
func test_feature_unload_cleans_up_event_listeners():
	...
	game_manager.subscribe("test_event", func(_data):
