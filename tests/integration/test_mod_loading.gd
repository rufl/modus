...
func test_mods_can_subscribe_to_events():
	...
	game_manager.subscribe("game_event", func(_data):
		_mod_received_event = true
	)
...
func test_mods_can_emit_custom_events():
	...
	game_manager.subscribe("mod_custom_event", func(_data):
		_custom_event_received = true
	)
...
func test_mods_can_extend_features():
	...
	if combat_feature:
		...
		game_manager.subscribe("combat_event", func(_data):
			_mod_extended_combat = true
		)
